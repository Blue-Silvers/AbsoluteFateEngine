...
TheDescentController::TheDescentController(Actor* pActor) : TheDescentMovingC(pActor)
{
...
void TheDescentController::OnNotify(SDL_Event& pEvent)
{
	switch (pEvent.type)
	{
	case SDL_KEYDOWN:
		...
		case SDLK_UP:
			...
			if (TheDescentPlayerA* theDescentPlayerA = dynamic_cast<TheDescentPlayerA*>(mOwner))
			{
				theDescentPlayerA->WalkAnim();
