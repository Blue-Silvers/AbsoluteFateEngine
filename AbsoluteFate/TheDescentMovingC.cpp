...
TheDescentMovingC::TheDescentMovingC(Actor* pOwner, int pUpdateOrder) : Components(pOwner, pUpdateOrder),
mSpeed(Vector3::zero)
{
}

void TheDescentMovingC::SetSpeed(Vector3 pSpeed)
{
    mSpeed = pSpeed;
}

void TheDescentMovingC::Update()
{
